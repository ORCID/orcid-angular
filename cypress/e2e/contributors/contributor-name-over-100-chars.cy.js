...
describe('contributor name over 100 characters', async function () {
  const workType = 'Book'
  const title = 'Cypress test contributors 22'
  const name = 'nameover100charnameover100charnameover100charnameover100charnameover100charnameover100charnameover100'
  ...
  qase(
    '22',
    it('contributor name over 100 characters (99)', function () {
