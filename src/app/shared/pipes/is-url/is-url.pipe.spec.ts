...
describe('IsUrlPipe', () => {
  ...
  it('should return true if is a valid url', () => {
    ...
    expect(pipe.transform('https://doi.org/10.1175/1520-0426(2000)017< 0854:aeosrb>2.0.co;2')).toBe(true);
  });

  it('should return false if is an invalid url', () => {
    expect(pipe.transform('url')).toBe(false);
    expect(pipe.transform('https%3A%2F%2Fdoi.org%2F10.1175%2F1520-0426(2000)017%3C%200854%3Aaeosrb%3E2.0.co%3B2')).toBe(false);
  });
});
