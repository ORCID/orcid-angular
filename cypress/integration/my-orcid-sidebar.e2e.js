describe('My Orcid sidebar' + runInfo(), () => {
  describe('Emails' + runInfo(), () => {
    ...
    it('remove/delete  emails and display those as "unverified" with default privacy', () => {
      // Expect changes to be display outside and inside of the modal
    })
    it('display emails "unverified" and "verified"', () => {
      // Expect changes to be display outside and inside of the modal
    })
    it('resend the email verification email', () => {
      // TODO @dandineen no button to resend
    })
    it('set a "checked" email as primary', () => {
      // checks that a secondary email does not have the `make primary` button
      // Expect changes to be display outside and inside of the modal
    })
