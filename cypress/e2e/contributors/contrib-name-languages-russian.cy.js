...
describe('contributor name - language - Russian', async function () {
  const workType = 'Book'
  const title = 'Cypress test contributors 25'
  const name = 'Евгений Денисов'

  before(() => {})

  qase(
    '25',
    it('contributor name - language - Russian', function () {
