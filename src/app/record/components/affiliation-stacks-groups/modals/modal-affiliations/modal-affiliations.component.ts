    ...
    return {
      ...
      startDate: {
        day: affiliationForm.get('startDateGroup.startDateDay').value ?
          this.addTrailingZero(affiliationForm.get('startDateGroup.startDateDay').value) : '',
        month: affiliationForm.get('startDateGroup.startDateMonth').value ?
          this.addTrailingZero(affiliationForm.get('startDateGroup.startDateMonth').value) : '',
      ...
      endDate: {
        day: affiliationForm.get('endDateGroup.endDateDay').value ?
          this.addTrailingZero(affiliationForm.get('endDateGroup.endDateDay').value) : '',
        month: affiliationForm.get('endDateGroup.endDateMonth') ?
          this.addTrailingZero(affiliationForm.get('endDateGroup.endDateMonth').value) : '',
