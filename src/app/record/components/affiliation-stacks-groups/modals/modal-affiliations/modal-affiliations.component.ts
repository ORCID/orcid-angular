  ...
  ngOnInit(): void {
    ...
    if (this.affiliation) {
      if (this.affiliation.endDate.year) {
        this.affiliationForm.patchValue({
          endDateGroup: {
            endDateYear: this.affiliation.endDate.year ? Number(this.affiliation.endDate.year) : '',
            endDateMonth: this.affiliation.endDate.month ? Number(this.affiliation.endDate.month) : '',
            endDateDay: this.affiliation.endDate.day ? Number(this.affiliation.endDate.day) : '',
          },
        })
      }
      ...
      if (this.affiliation.startDate.year) {
        this.affiliationForm.patchValue({
          startDateGroup: {
            startDateYear: this.affiliation.startDate.year ? Number(this.affiliation.startDate.year) : '',
            startDateMonth: this.affiliation.startDate.month ? Number(this.affiliation.startDate.month) : '',
            startDateDay: this.affiliation.startDate.day ? Number(this.affiliation.startDate.day) : '',
          },
        })
      }
