...
import { ResetPasswordEmailForm, ResetPasswordEmailFormValidate } from 'src/app/types/reset-password.endpoint'
...
export class PasswordRecoveryService {
  ...
  resetPasswordEmailValidateToken(resetPassword: ResetPasswordEmailFormValidate) {
    let encodedData = JSON.stringify(resetPassword)
    return this._http
      .post<ResetPasswordEmailForm>(
