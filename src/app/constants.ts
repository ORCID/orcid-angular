...
import { AffiliationType, AffiliationUIGroup } from './types/record-affiliation.endpoint'
...
export function getAffiliationType(affiliationUiGroups: AffiliationUIGroup[], type: string): AffiliationUIGroup {
