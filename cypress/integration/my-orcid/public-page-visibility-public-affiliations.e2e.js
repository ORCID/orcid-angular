...
describe('Public record page: validate public affiliations are displayed', async function () {
  ...
  it('Public employment data is displayed', function () {   
    cy.get('#cy-affiliation-employment').should('contain',testUser.publicEmployment)
  })
  it('Public education data is displayed', function () {  
    cy.get('#cy-affiliation-education-and-qualification').should('contain',testUser.publicEducation)
  })
  it('Public distintions data is displayed', function () {  
    cy.get('#cy-affiliation-invited-position-and-distinction').should('contain',testUser.publicDistinction)
  })
  it('Public services data is displayed', function () {  
    cy.get('#cy-affiliation-membership-and-service').should('contain',testUser.publicService)
  })
