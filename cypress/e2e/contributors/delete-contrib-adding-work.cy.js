...
describe('Delete contributor while adding a work', async function () {
  before(() => {
  ...
  qase(
    '7',
    it('Delete contributor while adding a work', function () {
      const workType = 'Book'
      const title = 'Cypress test contributors 7'
