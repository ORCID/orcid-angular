...
describe('contributor name - accented characters', async function () {
  const workType = 'Book'
  const title = 'Cypress test contributors 28'
  const name = 'àáâãäåçèéêëìíîðñòôõöö'

  before(() => {})

  qase(
    '28',
    it('contributor name - accented characters', function () {
