...
import { HttpHeaderInterceptor } from './core/http-header-interceptor/http-header-interceptor'
...
@NgModule({
  ...
  providers: [TitleService, {provide:HTTP_INTERCEPTORS, useClass:HttpHeaderInterceptor, multi:true}],
