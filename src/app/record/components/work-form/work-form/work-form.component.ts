...
export class WorkFormComponent implements OnInit {
  ...
  private loadWorkForm(currentWork: Work): void {
    this.workForm = this._fb.group({
      ...
      title: [currentWork?.title?.value || '', [Validators.required, Validators.maxLength(this.MAX_LENGTH_TITLE)]],
      ...
      subtitle: [currentWork?.subtitle?.value || '', [Validators.maxLength(this.MAX_LENGTH_TITLE)]],
      journalTitle: [currentWork?.journalTitle?.value || '', [Validators.maxLength(this.MAX_LENGTH_TITLE)]],
      ...
      citationGroup: this._fb.group(
        {
          ...
          shortDescription: [currentWork?.shortDescription?.value || '', [Validators.maxLength(this.MAX_LENGTH_DESCRIPTION)]],
        },
